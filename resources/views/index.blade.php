...
<head>
  ...
  <script>
    Flatdoc.run({
      fetcher: Flatdoc.github('swayechateau/pnt-users-api')
    });
  </script>
</head>
<body role='flatdoc'>
  ...
  <div class='header'>
    ...
    <div class='right'>
      ...
      <iframe src="https://ghbtns.com/github-btn.html?user=swayechateau&amp;repo=pnt-users-api&amp;type=watch&amp;count=true" allowtransparency="true" frameborder="0" scrolling="0" width="110" height="20"></iframe>
    </div>
  </div>
